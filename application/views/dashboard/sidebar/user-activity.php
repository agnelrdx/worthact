            ...
            <div data-id="<?= $act->time; ?>" class="sl-item">
                <a href="<?= $href; ?>">
                    <div class="sl-content">
                        ...
                        <p><?= ($act->user_type == 1) ? ucfirst(strtolower($act->firstname)) . ' ' . ucfirst(strtolower($act->lastname)) : ucfirst(strtolower($act->name)); ?> liked a <?php if($act->type == 'file' || $act->type == 'location' || $act->type == 'thought') { echo 'timeline post'; } else { if($act->type == 'ad'){ echo $this->hook->sos_type($act->type_id); } else if($act->type == 'comment') { echo 'comment'; } else { echo $act->type.' post.'; } } ?></p>
